...
public class FragmentEadapter extends BaseAdapter {

	private Context con;
    private int images[]={R.drawable.pictionary,R.drawable.ddrama};


	public FragmentEadapter(Context context) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
		  ...
		  // Typeface tfRegular = Typeface.createFromAsset(con.getAssets(),
